...
const reassignContract = async (executionLayer, createdAddress, rollupId) => {
...
const processTransaction = async (executionLayer, tx) => {
	if (tx.type === 'hub') {
...
const queryState = async (executionLayer, address) => {
...
const queryHub = async (executionLayer, rollupId) => {
	return executionLayer['rollups'][rollupId]
}

const debug = async (executionLayer) => {
