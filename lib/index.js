...
const processTransaction = async (tx) => {
	...
	if (tx.action === 'add_rollup') {
		...
		const unsignedTx2 = TransactionFactory.fromTxData({ gasPrice: GAS_PRICE, gasLimit: GAS_LIMIT, data: tx.params[0], nonce: nonceCount })
